...
class Game {
	...
	Game() {
		...
		this.YourInput = random.nextInt(100) + 1;
	}
	...
	public boolean takeUserInput() {
		if ( noOfGuesses < 10 ) {
			...
			this.YourGuess = NumberGuessingGame.takeIntegerInput(100);
			noOfGuesses++;
			return false;
		}
		else {
	...
	public boolean isCorrectGuess() {
		...
		if ( YourInput == YourGuess ) {
			System.out.println("Congratulations, you guess the number " + YourInput +
		...
		else if ( noOfGuesses < 10 && YourGuess > YourInput ) {
			if ( YourGuess - YourInput > 10 ) {
